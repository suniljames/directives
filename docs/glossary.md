...
| **Pipeline** | A multi-stage workflow (e.g., PM review → design → implement → code review → deploy → summarize). Each stage produces artifacts the next consumes. | Prevents skipping steps. Tracks progress with labels. |
