# Playbook Repo — Claude Code Config

This is a documentation repo. There is no application code, no tests, no build system.

## Rules

- Follow the GitHub identity rules in any project that references this playbook.
